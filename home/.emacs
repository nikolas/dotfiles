...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (terraform-mode go-mode mustache-mode rust-mode php-mode salt-mode nginx-mode rjsx-mode haskell-mode web-mode ag whitespace-cleanup-mode window-number git-gutter tuareg)))
 '(standard-indent 4)
